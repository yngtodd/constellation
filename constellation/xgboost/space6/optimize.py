...
def objective(params):
    ...
    * params [list, len(params)=n_hyperparameters]
    ...
    """
    eta, max_depth, subsample, colsample_bytree, alpha, = params
...
def main():
    ...
    parser.add_argument('--data_path', type=str, default='/lustre/atlas2/csc249/proj-shared/yngtodd/constellation/constellation/data/fashion')
