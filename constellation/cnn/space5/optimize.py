...
def model_cnn(num_classes=10, kernel1=5, kernel2=5, kernel3=1, lr=0.01, dropout=0.5):
    # create model
    model = Sequential()
...
def objective(params):
   ...
   #     print('\n Fold %d'%(fold))
        ...
        # build the model
        model = model_cnn(kernel1=kernel1, kernel2=kernel2, kernel3=kernel3, lr=lr, dropout=dropout)
        # fit model
        model.fit(
            X_tr,
            y_tr,
